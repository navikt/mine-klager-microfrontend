import styles from '@/src/components/icon.module.css';

interface IconProps {
  title: string;
}

export const CardIcon = ({ title }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 64 64" className={styles.icon}>
    <title>{title}</title>
